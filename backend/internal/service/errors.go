...
var (
	...
	ErrSplitNotAllowed    = errors.New("specimen status does not permit splitting")
	ErrInsufficientAmount = errors.New("remaining available amount is insufficient for the requested portions")
	ErrUndisposedChildren = errors.New("mother specimen cannot be disposed while it has undisposed child specimens")
)
